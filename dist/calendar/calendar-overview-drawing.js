...
export class CalendarOverviewDrawing {
    static drawCalendarOverview(canvas) {
        ...
        4 * widthUnit, // width
        2 * heightUnit, // height
        10, 10, CalendarService.getSeasonDarkerColour(calendar.Season), CalendarService.getSeasonLighterColour(calendar.Season), '#fff', () => GlobalComponents.globalServices.navigatorService.requestPageNavigation(Page.calendarDetails), ['Day ' + calendar.Day.toString(), CalendarService.getSeasonAsString(calendar.Season)]);
    }
}
