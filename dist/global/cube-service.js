...
export class CubeService {
    ...
    drawSubCube(colour, parentCoordX, parentCoordY, parentScale, subCubeScale, xStartPercent, yStartPercent, height = 0) {
    ...
    drawCustomColourSubCube(colour, parentCoordX, parentCoordY, parentScale, subCubeScale, xStartPercent, yStartPercent, height = 0) {
