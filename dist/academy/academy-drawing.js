...
import { AcademyBuildingType } from "./academy.js";
export class AcademyDrawing {
    ...
    drawBack(unload) {
        ...
        buttonService.createBtn(0, 0, 150, 50, 25, 1, Colour.autumn, Colour.lightAutumn, Colour.white, () => { unload(); }, ["Back"]);
    }
}
